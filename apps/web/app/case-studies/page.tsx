...
const caseStudies = [
  ...
  },
  {
    ...
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuCdyJos99wotvRiOJ8evOvwoLlFYKZG7TWTRymKz6cafEe5Z7hZHZq5WVdKLQCZmJNZp5ZRTjNKSlsrVvfHhCzYCKie_aWcDpLYbodpnJHNPNJyUewLjF8ub2cdu_d6YcV_ZkCgouz0GBuOerY0kJVHzLYI1Q0ckrTQBzd7BZeqJCkFPjpMSbxUpOcMHFs-ZIZigktQVxZUdKpM1OReYk7BtmZhEm01hgPyxuuqFQEmhbRDmV0AeCXsLCeuqB4gulNcZMrThs6KV2LN",
  },
  {
    id: 4,
    ...
    category: "Productivity",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuCsZ_ooWuD9UDigxZkF6MZPJg83wWbodlBs_ZVaLIWwxqZIRGTw20m06AJDWP0NsAaF_rTkxKC2ETXjc2ymS8yl_Jg0tmTtBKeiThQpD2cETvRa422r4GzbT9evawCL_R1jzf2vB_iJPtuEPs8jEsgyZ94vqj7AHHFibLUYcYNj0Q-SrAQDYkR0pBnqjMdqpRijFqdHw05l4yltmA7U7uMo74-IoY6dbXVNrsagA_DlCEGWj8P5lMFNThN_RHWm9E0zEnHujdAk0q7M",
  },
];
        ...
        <div className="flex flex-wrap gap-3 p-3 pr-4">
          {categories.map((category) => (
            <div key={category} className="relative">
              ...
              >
                <p className="text-sm font-medium leading-normal text-[#111418]">
                  {category}
                </p>
                <div
              ...
              {openDropdown === category && (
                <div className="absolute left-0 top-full z-10 mt-1 min-w-[120px] rounded-lg border border-[#f0f2f5] bg-white shadow-lg">
                  {categories.map((cat) => (
                    <button
                      key={cat}
                      className="block w-full px-4 py-2 text-left text-sm text-[#111418] first:rounded-t-lg last:rounded-b-lg hover:bg-[#f0f2f5]"
