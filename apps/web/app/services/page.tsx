...
const services = [
  {
    ...
    description:
      "Kickstart your AI journey with a focused strategy sprint. We'll identify key opportunities and create a roadmap for AI integration.",
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      "Automate repetitive tasks and streamline your business processes with AI-powered workflow solutions.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24px"
  ...
  },
  {
    ...
    description:
      "Develop bespoke AI agents tailored to your specific needs, enhancing efficiency and decision-making.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24px"
  ...
  },
  {
    ...
    description:
      "Empower your team with the skills to leverage AI effectively through our customized training programs.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24px"
      ...
      <div className="layout-content-container flex max-w-[960px] flex-1 flex-col">
        ...
        <div className="@container">
          <div className="@[480px]:p-4">
            <div
              className="@[480px]:gap-8 @[480px]:rounded-lg @[480px]:px-10 flex min-h-[480px] flex-col items-start justify-end gap-6 bg-cover bg-center bg-no-repeat px-4 pb-10"
              style={{
            ...
            >
              <div className="flex flex-col gap-2 text-left">
                ...
                <h2 className="@[480px]:text-base @[480px]:font-normal @[480px]:leading-normal text-sm font-normal leading-normal text-white">
                  ...
                  businesses leverage AI to automate workflows, build custom
                  agents, and upskill their teams.
                </h2>
              </div>
        ...
        {/* First Tab Section */}
        <div className="pb-3">
          <div className="flex gap-8 border-b border-[#dbe0e6] px-4">
          ...
          {services.map((service) => (
            ...
            >
              ...
              <div className="flex flex-col gap-1">
                <h2 className="text-base font-bold leading-tight text-[#111418]">
                  {service.title}
                </h2>
