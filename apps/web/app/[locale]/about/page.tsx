        ...
        <div className="w-full max-w-7xl">
          ...
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto max-w-3xl text-xl text-gray-600">
              Siamo il ponte tra l'intelligenza artificiale e il successo della
              tua azienda. Con esperienza consolidata e visione innovativa,
              trasformiamo le potenzialità dell'AI in risultati concreti.
            </p>
          </div>
          ...
          <div className="mb-16 grid gap-12 md:grid-cols-2">
            <div>
              ...
              <p className="mb-4 leading-relaxed text-gray-600">
                Crediamo che l'intelligenza artificiale non debba sostituire
                l'ingegno umano, ma amplificarlo. La nostra missione è guidare
                le aziende attraverso la trasformazione digitale, garantendo che
                ogni implementazione AI sia strategica, etica e orientata ai
                risultati.
              </p>
              <p className="leading-relaxed text-gray-600">
                Non siamo solo consulenti tecnologici: siamo partner strategici
                che comprendono le sfide uniche del tuo business e sviluppano
                soluzioni su misura per il tuo successo.
              </p>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-3">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Rimaniamo sempre all'avanguardia delle tecnologie AI per
                  offrirti soluzioni che definiscono il futuro del tuo settore.
                </p>
              </div>
              <div className="text-center">
                <div className="mb-4 flex justify-center">
                ...
                <p className="text-gray-600">
                  ...
                  caratterizzato da totale trasparenza sui processi e sui
                  risultati.
                </p>
              </div>
              <div className="text-center">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Esperto in strategia AI con oltre 10 anni di esperienza nella
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Architetto AI con expertise in machine learning e sviluppo di
                  sistemi scalabili.
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Specialista in implementazione AI con focus su soluzioni
                  enterprise e integration.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-lg bg-gradient-to-r from-blue-600 to-blue-800 p-8 text-center text-white">
            ...
            <p className="mb-6 text-xl">
              Scopri come l'intelligenza artificiale può rivoluzionare il tuo
              business.
            </p>
