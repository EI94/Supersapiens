      ...
      <div className="layout-container flex h-full grow flex-col">
        ...
        <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#223649] px-10 py-3">
          ...
          <div className="flex flex-1 justify-end gap-8">
            ...
            <button className="flex h-10 min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full bg-[#0b80ee] px-4 text-sm font-bold leading-normal tracking-[0.015em] text-white">
          ...
          <div className="layout-content-container flex max-w-[960px] flex-1 flex-col">
            ...
            <div className="@container">
              <div className="@[480px]:p-4">
                <div
                  className="@[480px]:gap-8 @[480px]:rounded-xl @[480px]:px-10 flex min-h-[480px] flex-col items-start justify-end gap-6 bg-cover bg-center bg-no-repeat px-4 pb-10"
                  style={{
                    backgroundImage:
                      'linear-gradient(rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.4) 100%), url("https://lh3.googleusercontent.com/aida-public/AB6AXuAl8cTCmZsEFOenaygdeBmGJIluprwVPIoDgnGwDQ2p1Z8CHQNvP4_xAPQfN4EOGBZtwIHj4wFyCSYfR5XVjF6m0a0sR2pawhrdYZ3-j_s9VcHliAt1aNjdgkFC0bxXahel0qUVII-pkSswWMxkVJG8qP19SLki1DOIYa9UnIWYI1i1iyjiTGwDJs-ELIltKRSMXKAgkTzdPd4TqnZMhr5LuDAmPqNWg8KpI6rhf4Iwx_r8_djLfqZetyMCIQlYOomILuWye2Lfl8iT")',
                  }}
                >
                  ...
                  <button className="@[480px]:h-12 @[480px]:px-5 @[480px]:text-base @[480px]:font-bold @[480px]:leading-normal @[480px]:tracking-[0.015em] flex h-10 min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full bg-[#0b80ee] px-4 text-sm font-bold leading-normal tracking-[0.015em] text-white">
                    <span className="truncate">
                      {locale === "it"
              ...
              <div className="flex items-stretch justify-between gap-4 rounded-xl">
                <div className="flex flex-[2_2_0px] flex-col gap-4">
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-sm font-normal leading-normal text-[#90aecb]">
                      {locale === "it"
                        ? "Definisci la visione, mappa le opportunità, crea la tua roadmap AI."
                        : "Define vision, map opportunities, craft your AI roadmap."}
                    </p>
                  </div>
                  <button className="flex h-8 w-fit min-w-[84px] max-w-[480px] cursor-pointer flex-row-reverse items-center justify-center overflow-hidden rounded-full bg-[#223649] px-4 text-sm font-medium leading-normal text-white">
                    <span className="truncate">
            ...
            <div className="p-4">
              <div className="flex items-stretch justify-between gap-4 rounded-xl">
                ...
                <div
                  ...
                  style={{
                    backgroundImage:
                      'url("https://lh3.googleusercontent.com/aida-public/AB6AXuAZJDwOKa6ICa33ia_OVBL4XACkOssJgPS0_i3FYB7EpH-ojMGrt2-1Iq3mnuU2Wp608ntgnnTdo8uyaNFEVay2ksZpiHlUHYS3Vq6ZwiOZnLqUopR-KKJ8nYcRgOKP5YvQTREVJTRmA5AWwEpm9Oo2gsG8jPAj-Sm8wndUuz0gsgBxwUdosufUOzVD-aEjWNps1hXU3QXTKUki-3aMHUbEeREIM2F1tIua0Sc3ElVZTBKEVoew-6hoghh-USRLQ1t4krgHRX-sqBVs")',
                  }}
                />
              </div>
            </div>
            ...
            <div className="p-4">
              <div className="flex items-stretch justify-between gap-4 rounded-xl">
                ...
                <div
                  ...
                  style={{
                    backgroundImage:
                      'url("https://lh3.googleusercontent.com/aida-public/AB6AXuBO2R5imKwBY-yARDKyLP3U_QmVW41Cmw9MQH_2gbDoIDR2icvGrt8NCXxBgxKF_87WbxiWlLm3_HY69B5ngV2kiclV342877ofY04DpLTOIkmaqNak0hvdLDFxoVx0BS8fOr71H_1R9FqMrkpKUuN0_OXxoq3buhuSEqRsHFOYB3-eQuQ-NltXtGQqLJokan7Nxcf3v2UIv6jiqwSaryAKAUNCciJEQAGXeVFK2573tcVFCP-CXumtU7jXL_u5JbHVAM0inbMjcOol")',
                  }}
                />
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-4 p-4">
              <div className="flex min-w-[158px] flex-1 flex-col gap-2 rounded-xl bg-[#223649] p-6">
                <p className="text-base font-medium leading-normal text-white">
                  {locale === "it"
                    ? "Soluzioni AI consegnate"
            ...
            {/* Quote Section */}
            <h2 className="tracking-light px-4 pb-3 pt-5 text-center text-[28px] font-bold leading-tight text-white">
              {locale === "it"
            ...
            <div className="@container">
              <div className="@[480px]:gap-8 @[480px]:px-10 @[480px]:py-20 flex flex-col justify-end gap-6 px-4 py-10">
                <div className="flex flex-col gap-2 text-center">
                  <h1 className="tracking-light @[480px]:text-4xl @[480px]:font-black @[480px]:leading-tight @[480px]:tracking-[-0.033em] max-w-[720px] text-[32px] font-bold leading-tight text-white">
                    {locale === "it"
                  ...
                  <label className="@[480px]:h-16 flex h-14 min-w-40 max-w-[480px] flex-1 flex-col">
                    <div className="flex h-full w-full flex-1 items-stretch rounded-xl">
                      <input
                        ...
                        className="form-input @[480px]:text-base @[480px]:font-normal @[480px]:leading-normal flex h-full w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl rounded-r-none border-r-0 border-none bg-[#223649] px-4 pr-2 text-sm font-normal leading-normal text-white placeholder:text-[#90aecb] focus:border-none focus:outline-0 focus:ring-0"
                        defaultValue=""
                      />
        ...
        <footer className="flex justify-center">
          <div className="flex max-w-[960px] flex-1 flex-col">
            <footer className="@container flex flex-col gap-6 px-5 py-10 text-center">
              ...
              <p className="text-base font-normal leading-normal text-[#90aecb]">
                © 2024 Supersapiens.{" "}
                {locale === "it"
