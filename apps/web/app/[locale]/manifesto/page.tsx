      ...
      <div className="layout-container flex h-full grow flex-col">
        ...
        <div className="flex flex-1 justify-center px-40 py-5">
          <div className="layout-content-container flex max-w-[960px] flex-1 flex-col">
            {/* Main Title */}
            <h1 className="tracking-light px-4 pb-3 pt-6 text-center text-[32px] font-bold leading-tight text-white">
              {locale === "it"
            ...
            {/* Principle 1 */}
            <div className="flex min-h-14 items-center gap-4 bg-[#101a23] px-4">
              <div
                className="flex size-10 shrink-0 items-center justify-center rounded-lg bg-[#223649] text-white"
                data-icon="NumberCircleOne"
                data-size="24px"
                data-weight="regular"
              >
                <svg
