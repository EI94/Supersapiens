            ...
            <div className="@container">
              <div className="@[480px]:p-4">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'linear-gradient(rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.4) 100%), url("https://lh3.googleusercontent.com/aida-public/AB6AXuDEOpx4lqPM9scP3Phx0aRdRpkExjDw8L3DSeI_So-uH4hsCg_h7vkLbxgH7kO_C9pyTPSW7qshSfi-2jO5PU4CrHeQkJRcBQTh_i6WBszfWEnyqG12kNZDmGqTU7io9Ofhx83rM3tWrr3v1Z3f3KNjOetthb3Dc01LYPX35AbCY7ZAqKh2FusxAnpaUkTL21SnxxGt82tvuGDq_ugPLLOpaXVCEJbUGw5dntloCfBlbvI2U9aOjjpsabTk3-bpdH2BiJ85_JUCOMpi")',
                  }}
                >
          ...
          <div className="flex max-w-[960px] flex-1 flex-col">
            <footer className="@container flex flex-col gap-6 px-5 py-10 text-center">
              <div className="@[480px]:flex-row @[480px]:justify-around flex flex-wrap items-center justify-center gap-6">
                <a
                  className="min-w-40 text-base font-normal leading-normal text-[#90adcb]"
                  href="#"
                >
