...
export const metadata: Metadata = {
  ...
  description:
    "Choose the perfect AI solution plan for your business needs. Transparent pricing for all our AI services.",
};
      ...
      <div className="layout-content-container flex max-w-[960px] flex-1 flex-col">
        ...
        <div className="p-4">
          <p className="pb-3 pt-1 text-base font-normal leading-normal text-[#111418]">
            Our pricing plans are designed to scale with your business. Contact
            our sales team to discuss custom enterprise solutions.
          </p>
